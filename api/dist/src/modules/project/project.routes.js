...
router.get("/:workspaceId/list_by_workspace", authMiddleware, requireWorkspaceRole(), validateBody(emptyBodySchema), projectController.listByWorkspace);
...
router.delete("/:workspaceId/remove/:projectId", authMiddleware, requireWorkspaceRole("admin"), validateBody(emptyBodySchema), projectController.remove);
