...
router.get('/invitees/:workspaceId', authMiddleware, validateParams(workspaceParamsSchema), validateBody(emptyBodySchema), validateQuery(paginationQuerySchema), requireWorkspaceRole('admin'), workspaceController.getInviteCandidates);
