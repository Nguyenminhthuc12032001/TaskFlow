...
import { acceptBodySchema, createBodySchema, inviteBodySchema, listInviteeCandidatesQuerySchema, listMemberByWorkspaceQuerySchema, listWorkspaceQuerySchema, removeMemberBodySchema, updateBodySchema, } from './workspace.schemas.js';
...
router.get('', authMiddleware, validateBody(emptyBodySchema), validateQuery(listWorkspaceQuerySchema), workspaceController.getByUserId);
...
router.get('/members/:workspaceId', authMiddleware, validateParams(workspaceParamsSchema), validateBody(emptyBodySchema), validateQuery(listMemberByWorkspaceQuerySchema), requireWorkspaceRole(), workspaceController.getMembersById);
...
router.get('/invitees/:workspaceId', authMiddleware, validateParams(workspaceParamsSchema), validateBody(emptyBodySchema), validateQuery(listInviteeCandidatesQuerySchema), requireWorkspaceRole('admin'), workspaceController.getInviteCandidates);
