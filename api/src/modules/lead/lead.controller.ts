...
import { safeLeadSchema, safeLeadsSchema, safeLeadTaskLinkSchema, type SafeLeadsType, type SafeLeadTaskLinkType, type SafeLeadType } from "./lead.schemas.js";
...
export class LeadController {
    ...
    listByWorkspace = async (req: Request<WorkspaceParams>, res: Response) => {
        ...
        const safeLeads: SafeLeadsType = leads.map((lead) => ({
            id: lead.id,
            workspaceId: lead.workspaceId,
            name: lead.name,
            stage: lead.stage,
